            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-2">
                    <div class="box box-primary">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/addAdmin" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="relname" placeholder="请输入联系人员姓名！">
                                </div>
                                <div class="form-group">
